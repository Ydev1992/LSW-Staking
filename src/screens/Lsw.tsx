                ...
                <Grid className="w-full h-full justify-center gap-4 md:px-[4%]">
                    ...
                    <Grid className="px-[6%]">
                        <DropDown title="How does LSW benefit viewers?">
                            <h2 className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 !font-roboto text-lg">LSW allows viewers to:</h2>
                            <ul className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 space-y-6 !list-disc !list-image-none !font-roboto text-lg">
                                ...
                                <li>Cut out the middleman and send more of their
                                    contribution directly to creators with lower transaction fees.
                                </li>
                        ...
                        <DropDown title="How does LSW benefit creators?">
                            <h2 className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 !font-roboto text-lg">LSW empowers creators to:</h2>
                            <ul className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 space-y-6 !list-disc !list-image-none !font-roboto text-lg">
                        ...
                        <DropDown title="How are LSW tokens allocated?">
                            <h2 className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 !font-roboto text-lg">LSW prioritizes creator success, platform growth,
                                and community engagement through its token allocation:
                            </h2>
                            <ul className="lg:text-[32px] lg:leading-[38px] font-medium ps-5 space-y-6 !list-disc !list-image-none !font-roboto text-lg">
                                <li>42.5%: Creator empowerment initiatives
                                    (direct support pools, content grants, engagement programs)
                                </li>
                                <li>35%: Platform growth and marketing
                                    (campaigns, development, partnerships)
                                </li>
                                <li>10%: Community rewards for early adopters and airdrops participants
                                </li>
                                <li>12.5%: Initial staking rewards (until full platform launch)
                                </li>
                            </ul>
                        </DropDown>

                        <DropDown title="Where can I learn more about LSW?">
                            <p className="lg:text-[32px] lg:leading-[38px] font-medium font-roboto text-lg">We encourage you to explore the official LSW website (link to be provided)
                                and follow our social media channels for the latest updates.
                                Stay tuned for exciting developments in the live streaming revolution powered by LSW!
                            </p>
                        </DropDown>
