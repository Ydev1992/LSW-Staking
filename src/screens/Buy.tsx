...
const Buy = () => {
    return (
        <section className="overflow-hidden">
            <Grid className="lg:px-20 p-6 py-[5%] gap-10">
                <Grid className="w-full h-full justify-center gap-1">
                    <h2 className="bg-clip-text text-transparent bg-gradient-to-l to-[#00C2B6] from-[#5865F2] lg:text-6xl font-bold">HOW TO BUY</h2>
                    <h2 className="text-white lg:text-2xl font-bold">How To Access lSW Mining</h2>
                </Grid>
                <div className="grid grid-cols-1 md:grid-cols-3 justify-between items-center gap-8 md:gap-60">
                    <Grid className="gap-3 items-center md:items-start">
                        ...
                        <h2 className="text-white text-md font-normal">Connect your wallet and use the presale widget at the top of the page to buy LSW tokens. You can use the ETH, BNB, or USDT. Make sure you have enough ETH or BNB to cover gas fees.  </h2>
                    </Grid>
