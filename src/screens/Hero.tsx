        ...
        <section className="overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 justify-between lg:px-10 bg-hero lg:py-[10%]">
                ...
                <Grid className="w-full h-full justify-center gap-4">
                    <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-[#00C2B6] to-[#5865F2] lg:text-[48px] lg:leading-[60px] font-extrabold font-inter">LIVE STREAMING POWER</h2>
                    <h3 className="font-bold text-white lg:text-[48px] lg:leading-[60px] font-inter">Power your Stream</h3>
                ...
                <Grid className="w-full h-full justify-center items-center">
                    <Grid className="bg-primary shadow-md rounded-md gap-6 w-[70%] py-8">
                        <Grid className="items-center gap-4 px-4">
                            <h2 className="lg:text-[48px] font-inter font-bold text-white">BUY LSW TOKEN</h2>
                            <h2 className="lg:text-[15px] text-white font-bold uppercase">Presale <span className="text-[#00C2B6]">live</span> {"\u2022"} ends by <span className="text-[#00C2B6]">1st jun 25 or hardcap </span></h2>
                        </Grid>
                        ...
                        <Grid className="items-center gap-4">
                            <Block className="bg-[#001C29] w-[60%] justify-between px-[8%] p-2 rounded-md">
