...
const Works = () => {
    return (
        <section className="overflow-hidden" >
            <div data-aos='fade-right' data-aos-delay="500" data-aos-easing="ease-in-out" className="grid grid-cols-1 justify-between lg:px-20 p-6 py-[5%] gap-10 transition-opacity">
